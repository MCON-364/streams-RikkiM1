...
public class StreamExercise {
    ...
    public List<String> getAllStudentNames() {
        ...
        return gradebook.keySet().stream()  // Stream the student names (keys)
                .sorted()
                .toList();
    }
    ...
    public List<Integer> getStudentGrades(String studentName) {
        ...
        // Group by department, then calculate average grade
        // Use Optional to safely handle missing student
    ...
    public long getTotalGradeCount() {
        ...
        return gradebook.values()  // Get all the lists of grades (values of the map)
                .stream()  // Stream the collection of grade lists
                .mapToLong(List::size)  // For each list, get the size (number of grades)
    ...
    public Map<String, List<String>> groupByPerformance() {
        return gradebook.entrySet()  // Stream over the entries (name -> grades)
                .stream()
                .collect(Collectors.groupingBy(entry -> {
                    ...
                    return "F";
                }, Collectors.mapping(Map.Entry::getKey, Collectors.toList())));  // Collect student names (keys)
    }
